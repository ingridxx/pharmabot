        ...
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>PharmaBot</h1>
            </div>
          ...
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">Ask PharmaBot for drug recommendations based on your conditions! You may also indicate unwanted side effects. Responses are sourced from a drug dataset stored in SingleStore.</p>
        </div>
